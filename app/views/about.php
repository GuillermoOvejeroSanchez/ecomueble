...
<body>
    ...
    <div class="miembro">
        <div id="noe" class="member_photo">
            <p>Noelia Calderón</p>
            <img src="img/Noelia.png" alt="Foto Noe">
        </div>
        <ul>
            <li>
    ...
    <div class="miembro">
        <div id="marta" class="member_photo">
            <p>Marta Ranz</p>
            <img src="img/Marta.png" alt="Foto Marta">
        </div>
        <ul>
            <li>
    ...
    <div class="miembro">
        <div id="rebeca" class="member_photo">
            <p>Rebeca Herranz</p>
            <img src="img/Rebeca.jpg" alt="Foto Rebe">
        </div>
        <ul>
            <li>
    ...
    <div class="miembro">
        <div id="adri" class="member_photo">
            <p>Adrián García</p> <img src="img/Adri.png" alt="Foto Adri">
        </div>
        <ul>
            <li>
    ...
    <div class="miembro">
        <div id="victor" class="member_photo">
            <p>Víctor Santamaría</p> <img src="img/Victor.jpg" alt="Foto Víctor">
        </div>
        <ul>
            <li>
    ...
    <div class="miembro">
        <div id="guille" class="member_photo">
            <p>Guillermo Ovejero</p> <img src="img/Will.png" alt="Foto Wilson">
        </div>
        <ul>
            <li>
    ...
    <div class="miembro">
        <div id="marlon" class="member_photo">
            <p>Marlon Campoverde</p>
            <img src="img/Marlon.png" alt="Foto Marlon">
        </div>
        <ul>
            <li>
